...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_path", type=str, required=True, help="Path to the dataset CSV"
    )
    parser.add_argument(
        "--target_column", type=str, required=True, help="The target column name"
    )
    parser.add_argument(
        "--task",
        type=str,
    ...
    parser.add_argument(
        "--generations", type=int, default=5, help="Number of generations for AutoML"
    )
    parser.add_argument(
        "--population_size", type=int, default=20, help="Population size for AutoML"
    )
